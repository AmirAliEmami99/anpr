...
def changeimage():
    ...
    my_lbl.image = kas
    print("chandtast ",len(maindic[li[neshangar]]['number']))
    for i in range(0, min(len(maindic[li[neshangar]]['number']),19)):
        ...
        labellistt[min(i * 2,19)].configure(image=shamorti[i])
        labellistt[min(i * 2,19)].image = shamorti[i]
        # labellistt[i].grid(row=i * 2, column=contor)
        contor += 1
        # labellistt[i * 2 + 1].config(text=len(javab[filez[0]]['number']))
        labellistt[min(i * 2+1,19)].config(text=maindic[li[neshangar]]['number'][i])
        contor += 1
def up():
    ...
    # print(javab['/Users/amirsajjad/Desktop/CarID_OCR/fashtkhudam/34214521-IRN_2021-09-02_14-22-54-773.jpg'].keys())
    # print(javab['/Users/amirsajjad/Desktop/CarID_OCR/fashtkhudam/34214521-IRN_2021-09-02_14-22-54-773.jpg']["pelakha"])
